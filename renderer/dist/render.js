 ...
 */
import { isTextNode, isElementNode, isComponentNode, isConditionalNode, isLoopNode, isBindingNode, isBinding, } from './ast';
/**
 * Evaluate a binding expression within the given state context
 */
export function evaluateBinding(expression, state) {
    try {
 ...
 */
export function evaluateAttribute(value, state) {
    if (isBinding(value)) {
 ...
 */
export function buildProps(attrs, state, onAction) {
    const props = {};
 ...
 */
export function renderNodes(nodes, context) {
